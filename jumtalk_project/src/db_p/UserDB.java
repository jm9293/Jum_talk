...
class sellUser {
   ...
   public sellUser(String name, String id, String phone, String profile_text) {
      super();
      this.name = name;
      this.id = id;
      this.phone = phone;
...
class normalUser {
   ...
   public normalUser(String name, String id, String phone, String gender) {
      super();
      this.name = name;
      this.id = id;
      this.phone = phone;
...
public class UserDB {
   ...
   static ArrayList<sellUser> getSELLER() {
      ...
      try {
         ...
         rs = stmt.executeQuery("SELECT id,name,phone, profile_text from userdata WHERE userkind = 1");
         ...
         while (rs.next()) {
            ...
            res.add(new sellUser(name, id, phone, profile_text));
         }
   ...
   static ArrayList<normalUser> getNomUser() {
      ...
      try {
         ...
         rs = stmt.executeQuery("SELECT id,name,phone, gender from userdata WHERE userkind = 0");
         ...
         while (rs.next()) {
            ...
            res.add(new normalUser(name, id, phone, gender));
         }
